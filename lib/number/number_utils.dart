...
class NumberUtils {
  ...
  static String nineDigits(int n) {
    ...
    if (n >= 10000000) return "0$n";
    if (n >= 1000000) return "00$n";
    if (n >= 100000) return "000$n";
    if (n >= 10000) return "0000$n";
    if (n >= 1000) return "00000$n";
    if (n >= 100) return "000000$n";
    if (n >= 10) return "0000000$n";
    return "00000000$n";
  }
  ...
  static String nDigits(int value, int n) {
    final result = value.toString();
    final supplement = n - result.length;
    if (supplement > 0) {
      StringBuffer zero = StringBuffer();
      for (int i = 0; i < supplement; ++i) {
        zero.write("0");
      }
      return "${zero.toString()}$result";
    }
    return result;
  }
}
